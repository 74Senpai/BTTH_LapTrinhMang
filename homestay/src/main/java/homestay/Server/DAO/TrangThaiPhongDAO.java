...
public class TrangThaiPhongDAO {
    ...
    public List<TrangThaiPhong> getAllTrangThai(Connection conn) throws SQLException {
     ...
     */
    public String getTenTrangThaiByMa(Connection conn, int maTrangThai) throws SQLException {
