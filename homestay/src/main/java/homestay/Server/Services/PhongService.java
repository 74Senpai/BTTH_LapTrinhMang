...
public class PhongService {
    ...
    public PhongDTO.ListPhong getAllPhong() throws Exception {
        ...
        try {
            ...
            for (Phong p : lstPhong) {
                PhongDTO.View dto = new PhongDTO.View(
                        p.getMaPhong(),
                        p.getTenPhong(),
                        p.getTenTrangThai(),
                        p.getSoDienHienTai(),
    ...
    public PhongDTO.ListPhong getPhongTrong() throws Exception {
        List<PhongDTO.View> result = new ArrayList<>();
        try {
            Connection conn = DBConnection.getConnection();
    ...
    public PhongDTO.View createPhong(PhongDTO.Create dto) {
        ...
        try {
            Connection conn = DBConnection.getConnection();
            maPhong = dao.insertPhong(conn, p);
        } catch (SQLException e) {
        ...
        return new PhongDTO.View(
                maPhong, dto.tenPhong(), "", 0, 0, dto.giaThueNgay(), dto.giaThueThang()
        );
    }
